...
<meta property="og:title" content="Train composition | European Sleeper">
<meta property="og:description" content="Discover the composition of the European Sleeper's Good Night Train for smooth boarding and an enjoyable journey. Find your carriage!">
<meta property="og:image" content="https://s3.eu-central-1.amazonaws.com/train.management/img/page-header/1700169557.webp"><meta content="Discover the composition of the European Sleeper's Good Night Train for smooth boarding and an enjoyable journey. Find your carriage!" name="description">
...
<meta name="theme-color" content="#40002c"><link href="/css/index/layout/default.css?v=1745779808" rel="stylesheet">    <link rel="canonical" href="https://www.europeansleeper.eu/train-composition">
<title>Train composition | European Sleeper</title>
</head>
<body>
...
<header class="bg-dark-aubergine text-white transition" id ="header">
    ...
    <div class="bg-white nav text-dark-aubergine">
                            <div class="relative">
                                    <a class="flex-inline" data-id="0" href="/">
                        Homepage                                            </a>
                                            </div>
                                <div class="relative">
                                    <a class="flex-inline" data-id="1" href="/destinations">
                        Destinations                        <span class="material-symbols-outlined">arrow_drop_down</span>                    </a>
                                                                        <div class="bg-white subnav text-dark-aubergine" data-id="1">
                        <div class="flex flex-row-wrap">
                                                                                                <a class="flex-50" href="/amsterdam">
                                        Amsterdam                                    </a>
                                                                                                                                <a class="flex-50" href="/antwerp">
                                        Antwerp                                    </a>
                                                                                                                                <a class="flex-50" href="/berlin">
                                        Berlin                                    </a>
                                                                                                                                <a class="flex-50" href="/bolzano">
                                        Bolzano                                    </a>
                                                                                                                                <a class="flex-50" href="/brussels">
                                        Brussels                                    </a>
                                                                                                                                <a class="flex-50" href="/dresden">
                                        Dresden                                    </a>
                                                                                                                                <a class="flex-50" href="/innsbruck">
                                        Innsbruck                                    </a>
                                                                                                                                <a class="flex-50" href="/prague">
                                        Prague                                    </a>
                                                                                                                                <a class="flex-50" href="/rotterdam">
                                        Rotterdam                                    </a>
                                                                                                                                <a class="flex-50" href="/venice">
                                        Venice                                    </a>
                                                                                    </div>
                    </div>
                            </div>
                                <div class="relative">
                                    <a class="flex-inline" data-id="2" href="/the-train">
                        The Train                                            </a>
                                            </div>
                                <div class="relative">
                                    <a class="active flex-inline text-shock-orange" data-id="3" href="/travel-info">
                        Travel info                        <span class="material-symbols-outlined">arrow_drop_down</span>                    </a>
    ...
    <ul class="bg-white" id="language">
                ...
                <a class="language-button" href="/nl/train-composition">
                    ...
                    <li>
                <a class="language-button" href="/de/train-composition">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 85.333 512 341.333" class="w-full h-full"><path fill="#D80027" d="M0 85.331h512v341.337H0z"></path><path d="M0 85.331h512v113.775H0z"></path><path fill="#FFDA44" d="M0 312.882h512v113.775H0z"></path></svg>                </a>
            </li>
                    <li>
                <a class="language-button" href="/fr/train-composition">
        ...
        <section class="bg-dark-aubergine full-xl padding-top radius-bottom text-white">
        <div class="max-w-90 wrapper">
            <div class="header">
                <div class="bg-img overlay radius" style="background-image:url(https://s3.eu-central-1.amazonaws.com/train.management/img/page-header/1717059574.webp)"><!-- --></div>
                <div class="header-txt max-w-42">
                    <h1>Train composition</h1>
                    <div class="text-body">
                        Check out the real-time train composition just before departure here.                    </div>
                </div>
                            </div>
        </div>
    </section>
            <section class="bg-white full radius-bottom text-dark-aubergine">
            <div class="max-w-42 wrapper">
                <h2></h2>
                <div class="font-light text">
                    <h3 style="text-align: center;">Find your carriage number here</h3>
<p style="text-align: center;">We're thrilled to have you aboard our Good Night Train soon!</p>                </div>
            </div>
        </section>
                <section class="bg-white full padding-top-0 radius-bottom text-dark-aubergine" id="section-train-layout">
    <div class="max-w-72 wrapper">
        <div class="flex">
                            <div class="flex-2 text-center" id="453">
                    <h3>Train ES 453</h3>
                    <table class="margin-auto">
                        <tr>
                            <td>Bruxelles-Midi</td>
                    ...
                    <div class="bg-light-gray coach coach-loc margin-top text-dark-aubergine">
                        ...
                        <span class="text-xs">Locomotive</span>
                                            ...
                                            <div class="bg-dark-aubergine coach text-white">
                            <h3 class="text-shock-orange">-</h3>
                            <p class="center-xy">
                                                                    <span class="material-symbols-outlined">airline_seat_flat</span>
                                                            </p>
                            <span class="text-xs">Couchette</span>
                        </div>
                                            <div class="bg-dark-aubergine coach text-white">
                            <h3 class="text-shock-orange">21</h3>
                            <p class="center-xy">
                            ...
                            <span class="text-xs">Sleeper</span>
                        </div>
                                            <div class="bg-dark-aubergine coach text-white">
                            <h3 class="text-shock-orange">17</h3>
                            <p class="center-xy">
                            ...
                            <span class="text-xs">Couchette</span>
                                            ...
                                            <div class="bg-dark-aubergine coach text-white">
                            <h3 class="text-shock-orange">11</h3>
                            <p class="center-xy">
                                                                    <span class="material-symbols-outlined">airline_seat_flat</span>
                                                            </p>
                            <span class="text-xs">Couchette</span>
                            ...
                            <div class="flex-2 text-center" id="452">
                    <h3>Train ES 452</h3>
                    <table class="margin-auto">
                        <tr>
                            <td>Prague hl.n. (main station)</td>
...
</section>            <section class="bg-dark-aubergine full radius-bottom text-white" id="section-newsletter">
    <div class="max-w-72 wrapper">
        <form id="form-newsletter">
            <input name="is_b2b" type="hidden" value="">
            <div class="bg-light-blue padding rounded text-dark-aubergine">
                <h3 class="text-heading">Sign up for our newsletter and receive special discounts, travel inspirations and the chance to win 2 European Sleeper Passes!</h3>
                <div class="flex margin-top">
                    <label for="voornaam">First name*</label>
                    <input class="required" id="voornaam" name="voornaam" placeholder="First name" required type="text">
                </div>
                <div class="flex margin-top">
                    <label for="achternaam">Last name</label>
                    <input id="achternaam" name="achternaam" placeholder="Last name" type="text">
                </div>
                <div class="flex margin-top">
                    <label for="email">E-mail*</label>
                    <input class="required" id="email" name="email" placeholder="E-mail" required type="email">
                </div>
            </div>
            <div class="bg-light-blue padding rounded text-dark-aubergine">
                <div class="flex flex-row">
                    <input class="required" id="subscribe" name="subscribe" required type="checkbox">
                    <label for="subscribe"><p>I give permission to receive emails regularly</p></label>
                </div>
                <button class="bg-white button rounded shadow-bottom-dark-aubergine" type="submit">
                    Subscribe                </button>
            </div>
        </form>
    </div>
...
<footer class="bg-lavender full text-dark-aubergine">
    <div class="max-w-90 wrapper">
        <div class="flex">
            <div class="flex-4">
                ...
                <ul class="font-light">
                            ...
                            <a href="/" target="_self">Home</a>
                                            ...
                                            <li>
                            <a href="/about-european-sleeper" target="_self">About European Sleeper</a>
                        </li>
                                            <li>
                            ...
                            <a href="/press" target="_self">Press</a>
                                            ...
                                            <li>
                            <a href="/become-our-partner" target="_self">Become our partner</a>
                        </li>
                                            <li>
                            <a href="/partner" target="_self">Login as partner</a>
                        </li>
                                    </ul>
            </div>
            <div class="flex-4">
                ...
                <ul class="font-light">
                                            <li>
                            <a href="/the-train" target="_self">The Train</a>
                        </li>
                                            <li>
                            <a href="/travel-info" target="_self">Travel info</a>
                        </li>
                                            <li>
                            <a href="/last-minutes-berlin-prague" target="_self">Last minute deals</a>
                        </li>
                                            <li>
                            <a href="/interrail" target="_self">Interrail / Eurail</a>
                        </li>
                                            <li>
                            <a href="/accessibility" target="_self">Accessibility/assistance</a>
                        </li>
                                            <li>
                            <a href="/train-travel-with-bike" target="_self">Travel with bike</a>
                        </li>
                                            <li>
                            <a href="/group-travel-by-night-train" target="_self">Group travel</a>
                        </li>
                                            <li>
                            <a href="/dining-car" target="_self">Dining Car</a>
                        </li>
                                            <li>
                            <a href="/passes" target="_self">European Sleeper Pass</a>
                        </li>
                                            <li>
                            <a href="/my-booking" target="_self">My booking</a>
                        </li>
                                            <li>
                            <a href="https://europeansleeper.freshdesk.com" target="_blank">FAQ</a>
                        </li>
                                    </ul>
            </div>
            <div class="flex-4">
            ...
            <div class="flex-4">
                ...
                <div class="flex flex-end text-shock-orange">
                    ...
                    <a aria-label="LinkedIn" href="https://www.linkedin.com/company/europeansleeper/?originalSubdomain=nl" target="_blank">
                    ...
                    <a aria-label="X" href="https://x.com/EuropeanSlpr" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50"><path fill="currentColor" d="M 5.9199219 6 L 20.582031 27.375 L 6.2304688 44 L 9.4101562 44 L 21.986328 29.421875 L 31.986328 44 L 44 44 L 28.681641 21.669922 L 42.199219 6 L 39.029297 6 L 27.275391 19.617188 L 17.933594 6 L 5.9199219 6 z M 9.7167969 8 L 16.880859 8 L 40.203125 42 L 33.039062 42 L 9.7167969 8 z"></path></svg>
                    </a>
        ...
        <div class="flex font-light">
            <span class="text-light-aubergine">&copy; 2025 — European Sleeper Exploitatie B.V.</span>
            <a href="/terms-and-conditions-and-privacy-policy">Terms & conditions</a>
            <a href="/terms-and-conditions-and-privacy-policy">Privacy policy</a>
            <div class="flex">
                <b class="text-light-aubergine">Secure Payment</b>
...
<script src="/js/jquery-3.7.1.min.js?v=1745779808"></script><script src="/js/index/layout/default.js?v=1745779808"></script><div class="bg-white text-dark-aubergine hidden" id="cookiebanner">
    <div class="max-w-90 padding wrapper">
        <div class="text-body">
            <p>We use strictly necessary cookies to make our site work. We also use analytics, functional, and targeting cookies to measure site usage, enhance navigation, and assist in marketing efforts. These cookies will only be set if you accept all cookies. For more details, see our cookie statement.</p>        </div>
        <div class="flex flex-end margin-top">
            <a class="underline" href="/terms-and-conditions-and-privacy-policy" target="_blank">More info</a>
            <button class="bg-lavender button duration-150 ease-in hover:bg-dark-lavender rounded text-dark-aubergine cookie-decline">Decline</button>
            <button class="bg-shock-orange button duration-150 ease-in hover:bg-darker-shock-orange rounded text-white cookie-accept">Accept</button>
        </div>
    </div>
</div>
    <script src="/js/index/partial/newsletter.js?v=1745779808"></script>    <script src="/js/index/partial/cookiebanner.js?v=1745779808"></script><script id="freshchat-widget" data-nscript="lazyOnload">
...
initiateCall();
        ...
        <img alt="Subscribe" src="https://s3.eu-central-1.amazonaws.com/train.management/index/img/es/newsletter-popup.webp">
        <form class="bg-white form padding text-dark-aubergine" id="popup-newsletter-form" method="post">
            <input name="is_b2b" type="hidden" value="false">
            <h3 class="text-heading">Win a European Sleeper Pass – Sign Up Today!</h3>
            <input class="required" id="popup-voornaam" name="voornaam" placeholder="First name" required type="text">
            <input class="required" id="popup-email" name="email" placeholder="E-mail" required type="email">
            <button class="bg-shock-orange button duration-150 ease-in flex-center hover:bg-darker-shock-orange rounded text-white w-full" type="submit">
                <p>Subscribe</p>            </button>
            <i class="flex flex-center text-dark-lavender text-s">
                Receive discounts, inspirations & tips!            </i>
        </form>
        <button aria-label="Close" class="bg-lavender popup-close" id="popup-newsletter-close">
            <span class="material-symbols-outlined">close</span>
        </button>
    </div>
    <script src="/js/index/partial/popup-newsletter.js"></script>
</body>
</html>
`
